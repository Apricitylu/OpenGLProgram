...
void setupVertices(void) {
    ...
    glGenBuffers(numVBOs, vbo);           // 像以前一样生成VBO，并新增一个用于索引
...
void init(GLFWwindow* window) {
    ...
    LocX = 0.25f; LocY = 0.0f; LocZ = -2.0f; // 沿Y轴下移以展示透视
    pyramidLocX = 0.0f; pyramidLocY = 0.0f; pyramidLocZ = 0.0f;
    setupVertices();
}
...
void display(GLFWwindow* window, double currentTime) {
    ...
    mMat *= glm::rotate(glm::mat4(1.0f), 0.3f, glm::vec3(1.0, 0.0, 0.0));
